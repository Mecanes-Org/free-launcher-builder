...
Au lieu de modifier manuellement des fichiers de configuration JSON, vous remplissez une interface graphique. Le générateur produit ensuite un **unique EXE portable** qui lance votre jeu, configuration incluse.

Chaque lanceur généré fonctionne avec le runtime [**Free Launcher**](https://github.com/Mecanes-Org/free-launcher), un projet autonome qui alimente l'EXE produit par ce générateur.
...
- **Détection du jeu** : sélectionnez votre exécutable, et le dossier du jeu entier est copié automatiquement.
...
2. Renseignez le nom du lanceur et le nom du jeu, puis sélectionnez l'exécutable du jeu.
3. Sélectionnez éventuellement une image de fond, une icône et une police, puis personnalisez les couleurs du bouton Play.
4. Cliquez sur **Générer le lanceur** et choisissez une destination. Le générateur crée :
